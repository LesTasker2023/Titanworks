...
console.log('Creating enhanced Sheet test that handles Radix Dialog behavior...');

const sheetTestPath = 'src/components/ui/Sheet/Sheet.test.tsx';

const newSheetTestContent = `import { render, screen, fireEvent, waitFor } from '@testing-library/react';
import userEvent from '@testing-library/user-event';
import { describe, expect, it, vi } from 'vitest';
import { Sheet, SheetContent, SheetTrigger, SheetHeader, SheetFooter } from './sheet';
...
fs.writeFileSync(sheetTestPath, newSheetTestContent);

console.log('✅ Sheet test file rewritten successfully');
console.log('Key changes:');
console.log('- Used defaultOpen={true} for testing open sheet state');
console.log('- Separate renderClosedSheet for testing trigger behavior');
console.log('- Added proper async/await for user interactions');
console.log('- Added waitFor for portal-rendered content');
console.log('- Fixed nested content expectations to match defaultOpen behavior');
console.log('- Added comprehensive interaction and accessibility tests');
