...
const componentRegistry = [
  ...
  },
  {
    ...
    features: ['Multiple chart types', 'Interactive tooltips', 'Responsive'],
  },
  ...
  // Navigation Components
  {
    ...
    features: ['Collapsible sections', 'Multiple open', 'Keyboard navigation'],
  },
  {
    name: 'Breadcrumb',
    demo: BreadcrumbDemo,
    ...
    features: ['Hierarchy display', 'Custom separators', 'Link navigation'],
  },
  {
    name: 'Tabs',
    demo: TabsDemo,
    ...
    features: ['Multiple orientations', 'Controlled state', 'Keyboard navigation'],
  },
  {
    name: 'NavigationMenu',
    ...
    features: ['Dropdown menus', 'Keyboard navigation', 'Mobile responsive'],
  },
  {
    name: 'Menubar',
    demo: MenubarDemo,
    ...
    features: ['Menu organization', 'Keyboard shortcuts', 'Nested menus'],
  },
  {
    name: 'Pagination',
    demo: PaginationDemo,
  ...
  },
  {
    ...
    testCount: 20,
    storyCount: 2,
    location: 'src/components/ui/Command/',
    features: ['Search interface', 'Keyboard navigation', 'Grouped commands'],
  },
  ...
  },
  {
    ...
    features: ['Horizontal/vertical', 'Custom styling', 'Spacing control'],
  },
  {
    name: 'AspectRatio',
    ...
    testCount: 16,
    storyCount: 1,
    location: 'src/components/ui/AspectRatio/',
    features: ['Responsive ratios', 'Image containers', 'Video embeds'],
  },
  {
    name: 'ScrollArea',
    demo: ScrollAreaDemo,
    ...
    testCount: 16,
    storyCount: 1,
    location: 'src/components/ui/ScrollArea/',
    features: ['Custom scrollbars', 'Overflow handling', 'Smooth scrolling'],
  },
  {
    name: 'Resizable',
    demo: ResizableDemo,
    ...
    testCount: 16,
    storyCount: 1,
    location: 'src/components/ui/Resizable/',
    features: ['Drag handles', 'Size constraints', 'Panel layouts'],
  },
  {
    name: 'Collapsible',
    ...
    testCount: 16,
    storyCount: 1,
    location: 'src/components/ui/Collapsible/',
    features: ['Toggle state', 'Animation', 'Content hiding'],
  },
  ...
  // Overlay Components
  {
    ...
    features: ['Modal dialogs', 'Overlay management', 'Focus trapping'],
  },
  {
    name: 'AlertDialog',
    ...
    testCount: 16,
    storyCount: 1,
    location: 'src/components/ui/AlertDialog/',
    features: ['Confirmation dialogs', 'Action buttons', 'Critical warnings'],
  },
  {
    name: 'Sheet',
    demo: SheetDemo,
    category: 'Overlay',
    description: 'Side panels and sheets',
    status: 'Production Ready',
    hasTests: true,
    hasStories: true,
    testCount: 22,
    storyCount: 1,
    location: 'src/components/ui/Sheet/',
    features: ['Slide-out panels', 'Multiple positions', 'Content containers'],
  },
  {
    name: 'Popover',
    demo: PopoverDemo,
    ...
    testCount: 20,
    storyCount: 2,
    location: 'src/components/ui/Popover/',
    features: ['Floating content', 'Positioning', 'Click outside'],
  },
  {
    name: 'HoverCard',
    demo: HoverCardDemo,
    ...
    testCount: 18,
    storyCount: 1,
    location: 'src/components/ui/HoverCard/',
    features: ['Hover triggers', 'Rich content', 'Delayed display'],
  },
  {
    name: 'Tooltip',
    demo: TooltipDemo,
    ...
    features: ['Hover tooltips', 'Positioning', 'Delay controls'],
  },
  {
    name: 'ContextMenu',
    ...
    testCount: 25,
    storyCount: 2,
    location: 'src/components/ui/ContextMenu/',
    features: ['Right-click menus', 'Menu items', 'Keyboard navigation'],
  },
  {
    name: 'DropdownMenu',
    ...
    testCount: 25,
    storyCount: 1,
    location: 'src/components/ui/DropdownMenu/',
    features: ['Dropdown menus', 'Sub-menus', 'Icon support'],
  },
  {
    name: 'Modal',
    demo: ModalDemo,
    category: 'Overlay',
    description: 'General modal overlays',
    status: 'Production Ready',
    hasTests: true,
    hasStories: true,
    testCount: 25,
    ...
    features: ['Modal overlays', 'Custom content', 'Backdrop control'],
  },
  ...
  // Feedback Components
  {
    ...
    features: ['Status variants', 'Icon support', 'Dismissible'],
  },
  {
    name: 'Toast',
    demo: ToastDemo,
    ...
    features: ['Notification system', 'Auto-dismiss', 'Action buttons'],
  },
  {
    name: 'Progress',
    demo: ProgressDemo,
    ...
    features: ['Progress bars', 'Percentage display', 'Color variants'],
  },
  {
    name: 'Skeleton',
    demo: SkeletonDemo,
    ...
    features: ['Loading states', 'Animated shimmer', 'Shape variants'],
  },
  {
    name: 'Sonner',
    demo: SonnerDemo,
    ...
    testCount: 14,
    storyCount: 1,
    location: 'src/components/ui/Sonner/',
    features: ['Toast library', 'Rich notifications', 'Positioning'],
  },
  ...
  // Utility Components
  {
    ...
    features: ['Theme switching', 'System detection', 'Persistent settings'],
  },
];
                        ...
                        <div className="flex items-center gap-4 text-xs text-muted-foreground flex-wrap">
                          ...
                          {component.hasTests && (
                            <div className="flex items-center gap-1 text-green-600">
                              ...
                              <span>Tests ({component.testCount})</span>
                            </div>
                          )}
                          {component.hasStories && (
                            <div className="flex items-center gap-1 text-blue-600">
                              <FileText className="w-3 h-3" />
                              <span>Stories ({component.storyCount})</span>
                            </div>
                          )}
                        </div>
