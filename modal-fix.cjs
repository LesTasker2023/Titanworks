...
const newTestContent = `import { render, screen, fireEvent } from '@testing-library/react';
...
console.log('Rewriting Modal tests to handle portal rendering...');

// Write the new test file
fs.writeFileSync(modalTestPath, newTestContent);

console.log('✅ Modal test file rewritten successfully');
console.log('Key changes:');
console.log('- Added portal={false} to BasicModal component for non-portal testing');
console.log('- Created separate PortalModal component for portal-specific tests');
console.log('- Fixed snapshot tests to handle portal rendering properly');
console.log('- Added comprehensive tests for modal header/footer components');
console.log('- Added interaction tests for overlay clicks and escape key');
console.log('- Added accessibility and variant tests');
console.log('- Fixed children content expectations');
