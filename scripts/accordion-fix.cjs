...
describe('Accordion', () => {
  const BasicAccordion = ({ children, ...props }: { children?: React.ReactNode; [key: string]: any }) => (
    <Accordion 
  ...
  describe('Custom Styling and Props', () => {
    it('accepts custom className', () => {
      render(<BasicAccordion className="custom-class" />);
...
const filePath = 'src/components/ui/Accordion/Accordion.test.tsx';

try {
  fs.writeFileSync(filePath, newContent);
  console.log('✅ Accordion test file completely rewritten with proper structure');
} catch (error) {
